    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="ns-tn-controller/hang-ton-controller.php?yeucau=huydonhang" method="post">
...
<div class="modal fade" id="huydonhangdatao" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                Bạn muốn hủy đơn hàng đang tạo ?
                <form action="ns-tn-controller/hang-ton-controller.php?yeucau=huydonhangdatao" method="post">
                    <div class="form-group">
                        <input type="text" name="makhachhang" class="form-control rounded-pill d-none" value=<?php echo $makhachhang; ?> readonly >
                        <input type="text" name="mahangton" class="form-control rounded-pill d-none" value=<?php echo $mahangton; ?> readonly >
                    </div>
                    <div class="d-flex justify-content-end">
                        <button type="button" class="btn btn-brown mr-3" data-dismiss="modal">Đóng</button>
                        <button type="submit" class="btn btn-danger">Tiến Hành Hủy</button>
