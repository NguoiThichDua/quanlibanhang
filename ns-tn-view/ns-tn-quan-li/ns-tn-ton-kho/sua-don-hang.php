                                    ...
                                    <div class="card bg-custom">
                                        ...
                                        <div class="card-body">
                                                    ...
                                                    <?php
                                                        ...
                                                        ?>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <button onclick="SuaThongTinHangHoaDonHangTon('<?php echo $tt->mahangton?>','<?php echo $tt->makhachhang; ?>','<?php echo $tt->machitiethanghoahangton?>', '<?php echo $tt->soluong?>')" type="button" class="btn btn-primary" data-toggle="modal" data-target="#suathongtindonhangdatao">
                                                                        Sửa
                                                                    </button>
                                                                </td>
                                                            </tr>
                                            ...
                                            <div class="mt-0">
                                                ...
                                                <a href="index.php?page=quanlitonkho" class="btn btn-success mt-3 hvr-bounce-out">Xác Nhận Thay Đổi</a>
                                            </div>
