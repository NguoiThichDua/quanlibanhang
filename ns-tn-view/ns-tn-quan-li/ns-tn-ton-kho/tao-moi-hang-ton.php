        ...
        <div class="row">
            ...
            <?php
                ...
                if(isset($_GET['id'])){ 
                    ...
                    if($thongtin != NULL){
                        if(isset($_GET['page']) == 'suadonhangton'){
                        ?>
                            <marquee behavior="alternate">Bạn đang TẠO đơn hàng tồn cho nhà phân phối: <b><u><?php echo "  " . $thongtin->hovaten;?></u></b></marquee>
                        <?php
                        }else{
                        ?>
                            <marquee behavior="alternate">Bạn đang TẠO đơn hàng tồn cho nhà phân phối: <b><u><?php echo "  " . $thongtin->hovaten;?></u></b></marquee>
                                                    ...
                                                    <?php
                                                        ...
                                                        ?>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <button onclick="SuaThongTinHangHoaDonHangTon('<?php echo $tt->mahangton?>','<?php echo $tt->makhachhang; ?>','<?php echo $tt->machitiethanghoahangton?>', '<?php echo $tt->soluong?>')" type="button" class="btn btn-primary" data-toggle="modal" data-target="#suathongtindonhang">
                                                                        Sửa
                                                                    </button>
                                                                </td>
                                                            </tr>
                    ...
                    <div class="col-md-6">
                        <div class="card p-3 bg-custom">
                            ...
                            <div class="form-group mb-0">
                                <button type="button" class="btn btn-primary mt-3" onclick="SoDienThoaiThemDonHangTon()">Tìm</button>
                            </div>
                        </div>
                    </div>
                </div>
